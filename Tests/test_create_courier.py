...
class TestCreateCourier:
    ...
    @allure.title('Невозможность зарегистрироваться курьером с уже используемым логином')
    ...
    @allure.title('Невозможность зарегистрироваться курьером без обязательного поля')
